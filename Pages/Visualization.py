...
st.set_page_config(page_title="Car Visualizations", layout="wide")
...
st.markdown("""
    ...
    <div class="title-style">📈 Visualization and Analysis</div>
...
if analysis_type == "Univariate":
    ...
    if pd.api.types.is_numeric_dtype(df[col1]) and pd.api.types.is_numeric_dtype(df[col2]):
        ...
        st.warning("Bivariate plot not available for selected combination.")
